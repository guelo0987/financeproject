...
class MenudoBudget {
  ...
  double get displayIncomeBase => ingresos > 0 ? ingresos : actualIncomeTotal;
  ...
  MenudoBudget(
    ...
    cats: {
      ...
      "estiloVida": BudgetCategory(
        categoryId: 4,
        label: "Tours",
        icono: MenudoCupertinoIcons.plane,
        color: AppColors.b5,
        limite: 15000,
        gastado: 0,
      ),
...
final List<MenudoTransaction> mockTxns = [
  ...
  const MenudoTransaction(
    ...
    monto: -5000,
    tipo: "transferencia",
    icono: MenudoCupertinoIcons.arrowLeftRight,
    fromAccountId: 1,
    toAccountId: 4,
...
final List<MenudoCategory> mockCategories = [
  ...
  const MenudoCategory(
    ...
    nombre: 'Ingresos',
    tipo: 'ingreso',
    icono: MenudoCupertinoIcons.trendingUp,
  ...
  const MenudoCategory(
    ...
    nombre: 'Salario',
    tipo: 'ingreso',
    icono: MenudoCupertinoIcons.briefcase,
    color: Color(0xFF10B981),
    esSistema: true,
  ...
  const MenudoCategory(
    ...
    nombre: 'Freelance',
    tipo: 'ingreso',
    icono: MenudoCupertinoIcons.laptop,
    color: Color(0xFF10B981),
    esSistema: true,
    categoriaParadreId: 8,
  ),
  const MenudoCategory(
    ...
    nombre: 'Inversiones',
    tipo: 'ingreso',
    icono: MenudoCupertinoIcons.barChart2,
    color: Color(0xFF10B981),
    esSistema: true,
    categoriaParadreId: 8,
  ),
  const MenudoCategory(
    ...
    nombre: 'Negocio',
    tipo: 'ingreso',
    icono: MenudoCupertinoIcons.store,
    color: Color(0xFF10B981),
    esSistema: true,
    categoriaParadreId: 8,
  ),
  const MenudoCategory(
    ...
    nombre: 'Bono',
    tipo: 'ingreso',
    icono: MenudoCupertinoIcons.gift,
    color: Color(0xFF10B981),
    esSistema: true,
    categoriaParadreId: 8,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'alquiler',
    nombre: 'Alquiler',
    icono: MenudoCupertinoIcons.keySquare,
    color: Color(0xFF065F46),
    esSistema: true,
  ...
  const MenudoCategory(
    ...
    slug: 'electricidad',
    nombre: 'Electricidad',
    icono: MenudoCupertinoIcons.zap,
    color: Color(0xFF065F46),
    esSistema: true,
    categoriaParadreId: 1,
  ),
  const MenudoCategory(
    ...
    slug: 'agua',
    nombre: 'Agua',
    icono: MenudoCupertinoIcons.droplets,
    color: Color(0xFF065F46),
    esSistema: true,
    categoriaParadreId: 1,
  ),
  const MenudoCategory(
    ...
    slug: 'internet',
    nombre: 'Internet',
    icono: MenudoCupertinoIcons.wifi,
    color: Color(0xFF065F46),
    esSistema: true,
    categoriaParadreId: 1,
  ),
  const MenudoCategory(
    ...
    slug: 'seguros',
    nombre: 'Seguros',
    icono: MenudoCupertinoIcons.shield,
    color: Color(0xFF065F46),
    esSistema: true,
    categoriaParadreId: 1,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'cafe',
    nombre: 'Café',
    icono: MenudoCupertinoIcons.coffee,
    color: Color(0xFFF97316),
    esSistema: true,
    categoriaParadreId: 2,
  ),
  const MenudoCategory(
    ...
    slug: 'delivery',
    nombre: 'Delivery',
    icono: MenudoCupertinoIcons.package,
    color: Color(0xFFF97316),
    esSistema: true,
    categoriaParadreId: 2,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'transito',
    nombre: 'Tránsito',
    icono: MenudoCupertinoIcons.bus,
    color: Color(0xFF7C3AED),
    esSistema: true,
    categoriaParadreId: 3,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'ropa',
    nombre: 'Ropa',
    icono: MenudoCupertinoIcons.shirt,
    color: Color(0xFFEC4899),
    esSistema: true,
  ...
  const MenudoCategory(
    ...
    slug: 'mascotas',
    nombre: 'Mascotas',
    icono: MenudoCupertinoIcons.heart,
    color: Color(0xFFEC4899),
    esSistema: true,
    categoriaParadreId: 4,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'medico',
    nombre: 'Médico',
    icono: MenudoCupertinoIcons.stethoscope,
    color: Color(0xFFEF4444),
    esSistema: true,
    categoriaParadreId: 5,
  ),
  const MenudoCategory(
    ...
    slug: 'dentista',
    nombre: 'Dentista',
    icono: MenudoCupertinoIcons.smile,
    color: Color(0xFFEF4444),
    esSistema: true,
    categoriaParadreId: 5,
  ),
  const MenudoCategory(
    ...
    slug: 'gimnasio',
    nombre: 'Gimnasio',
    icono: MenudoCupertinoIcons.dumbbell,
    color: Color(0xFFEF4444),
    esSistema: true,
    categoriaParadreId: 5,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'cursos',
    nombre: 'Cursos',
    icono: MenudoCupertinoIcons.monitorPlay,
    color: Color(0xFF3B82F6),
    esSistema: true,
  ...
  const MenudoCategory(
    ...
    slug: 'libros',
    nombre: 'Libros',
    icono: MenudoCupertinoIcons.book,
    color: Color(0xFF3B82F6),
    esSistema: true,
    categoriaParadreId: 6,
  ),
  ...
  const MenudoCategory(
    ...
    slug: 'cine',
    nombre: 'Cine',
    icono: MenudoCupertinoIcons.film,
    color: Color(0xFF8B5CF6),
    esSistema: true,
  ...
  const MenudoCategory(
    ...
    slug: 'viajes',
    nombre: 'Viajes',
    icono: MenudoCupertinoIcons.map,
    color: Color(0xFF8B5CF6),
    esSistema: true,
    categoriaParadreId: 7,
  ),
...
enum AssetCategory {
  cash(
    'Cash',
    '💵',
    AppColors.categoryCash,
    MenudoCupertinoIcons.account_balance_wallet_rounded,
  ),
  investments(
    'Inversiones',
    '📈',
    AppColors.categoryInvestments,
    MenudoCupertinoIcons.trending_up,
  ),
  crypto('Crypto', '₿', AppColors.categoryCrypto, MenudoCupertinoIcons.coins),
  realEstate(
    'Bienes Raíces',
    '🏠',
  ...
  vehicles(
    ...
    MenudoCupertinoIcons.directions_car,
  ),
  bankAccounts(
    'Cuentas Bancarias',
    '🏦',
