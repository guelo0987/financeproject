...
import '../theme/menudo_cupertino_icons.dart';
import 'models.dart';
...
class MockData {
  ...
  static double get totalNetWorthDOP {
    ...
    for (final asset in assets) {
      total += asset.currency == 'USD'
          ? asset.currentValue * usdToDop
          : asset.currentValue;
    }
    return total;
  }
  ...
  static List<Transaction> get recentTransactions => [
    Transaction(
      ...
      category: 'Salario',
      icon: MenudoCupertinoIcons.work,
    ...
    Transaction(
      ...
      type: TransactionType.income,
      category: 'Dividendos',
      icon: MenudoCupertinoIcons.trending_up,
    ...
    Transaction(
      ...
      category: 'Vivienda',
      icon: MenudoCupertinoIcons.home,
    ...
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Transporte',
      icon: MenudoCupertinoIcons.directions_car,
      date: DateTime(2026, 2, 27),
      assetName: 'Banco BHD León',
    ),
    Transaction(
      ...
      icon: MenudoCupertinoIcons.shoppingCart,
    ...
    Transaction(
      ...
      type: TransactionType.income,
      category: 'Otros',
      icon: MenudoCupertinoIcons.swap_horiz,
      date: DateTime(2026, 2, 26),
      assetName: 'Banco Popular',
    ),
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Servicios',
      icon: MenudoCupertinoIcons.electrical_services,
    ...
    Transaction(
      ...
      icon: MenudoCupertinoIcons.movie,
      date: DateTime(2026, 2, 25),
      assetName: 'Banco Popular',
    ),
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Alimentación',
      icon: MenudoCupertinoIcons.restaurant,
    ...
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Salud',
      icon: MenudoCupertinoIcons.stethoscope,
      date: DateTime(2026, 2, 22),
    ...
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Transporte',
      icon: MenudoCupertinoIcons.fuel,
    ...
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Deudas',
      icon: MenudoCupertinoIcons.account_balance,
    ...
    Transaction(
      ...
      type: TransactionType.expense,
      category: 'Salud',
      icon: MenudoCupertinoIcons.health_and_safety,
      date: DateTime(2026, 2, 15),
      assetName: 'Banco Popular',
    ),
  ];
