...
class _AddWalletSheetState extends State<AddWalletSheet> {
  ...
  final List<Map<String, dynamic>> _typeOptions = [
    {'label': 'Gastos', 'sub': 'Cuenta corriente o efectivo', 'tipo': 'gasto', 'color': AppColors.e6},
    {'label': 'Ahorro', 'sub': 'Ahorros, fondos, inversiones', 'tipo': 'ahorro', 'color': AppColors.b5},
    {'label': 'Deuda', 'sub': 'Tarjeta de crédito, préstamo', 'tipo': 'deuda', 'color': AppColors.r5},
  ];

  final List<IconData> _iconOptions = [
    LucideIcons.landmark, LucideIcons.creditCard, LucideIcons.banknote,
    LucideIcons.piggyBank, LucideIcons.shieldAlert, LucideIcons.building,
    LucideIcons.wallet, LucideIcons.coins,
  ];

  final List<Color> _colorOptions = [
    AppColors.b5, AppColors.e6, AppColors.o5, AppColors.p5,
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text("Nueva cuenta", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.e8)),
                    GestureDetector(
                      onTap: () => Navigator.pop(context),
                      child: Container(width: 32, height: 32, decoration: BoxDecoration(color: AppColors.g1, borderRadius: BorderRadius.circular(10)), alignment: Alignment.center, child: const Icon(LucideIcons.x, size: 18, color: AppColors.g5)),
                    ),
                  ],
                ),
              ),
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                        ...
                        children: List.generate(_typeOptions.length, (i) {
                          ...
                          return Expanded(
                            child: GestureDetector(
                              onTap: () { HapticFeedback.selectionClick(); setState(() => _typeIndex = i); },
                              child: AnimatedContainer(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: isSelected ? color : AppColors.g4),
                                ),
                              ),
                            ),
                          );
                    ...
                    Text(_typeOptions[_typeIndex]['sub'], style: const TextStyle(fontSize: 12, color: AppColors.g4), textAlign: TextAlign.center),
                    ...
                    Center(
                      child: Column(
                        children: [
                          Text(_typeIndex == 2 ? "SALDO DE DEUDA" : "SALDO INICIAL", style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: AppColors.g4, letterSpacing: 0.5)),
                          ...
                          Row(
                            ...
                            children: [
                              Text(_typeIndex == 2 ? '-RD\$' : 'RD\$', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.g3)),
                              const SizedBox(width: 4),
                              Text(
                                _amount.isEmpty ? "0" : _amount,
                                style: TextStyle(fontSize: 44, fontWeight: FontWeight.w800, letterSpacing: -1.5, color: _typeIndex == 2 ? AppColors.r5 : AppColors.e8),
                              ),
                            ],
                          ),
                        ],
                    ...
                    // Name field
                    Container(
                      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(18), border: Border.all(color: const Color(0xFFF3F4F6), width: 1.5)),
                      padding: const EdgeInsets.all(16),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text("Nombre de la cuenta", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.g4)),
                            ...
                            children: _iconOptions.map((icon) {
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  width: 44, height: 44,
                                  decoration: BoxDecoration(
                                    color: isSel ? _selectedColor.withValues(alpha: 0.15) : AppColors.g1,
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(color: isSel ? _selectedColor : Colors.transparent, width: 2),
                                  ),
                                  alignment: Alignment.center,
                                  child: Icon(icon, size: 20, color: isSel ? _selectedColor : AppColors.g4),
                                ),
                              );
                            }).toList(),
                          ),
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: isSel ? AppColors.e8 : Colors.transparent, width: 3),
                                  ),
                                  alignment: Alignment.center,
                                  child: isSel ? const Icon(LucideIcons.check, size: 16, color: Colors.white) : null,
                                ),
                              );
                            }).toList(),
                          ),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: canSave ? [const BoxShadow(color: Color(0x44F97316), blurRadius: 16, offset: Offset(0, 6))] : [],
                    ),
                    alignment: Alignment.center,
                    child: Text("Agregar cuenta", style: TextStyle(color: canSave ? Colors.white : AppColors.g4, fontSize: 16, fontWeight: FontWeight.w800)),
                  ),
                ),
              ),
            ],
