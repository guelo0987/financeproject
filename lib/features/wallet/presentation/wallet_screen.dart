...
class WalletScreen extends ConsumerWidget {
  ...
  void _openAddWallet(BuildContext context, WidgetRef ref) {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return walletAsync.when(
      loading: () => _buildScaffold(context, ref, [], isLoading: true),
      error: (e, _) => _buildScaffold(context, ref, [], error: e.toString()),
      data: (wallets) => _buildScaffold(context, ref, wallets),
    );
  }

  Widget _buildScaffold(BuildContext context, WidgetRef ref, List<WalletAccount> wallets, {bool isLoading = false, String? error}) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: () => _openAddWallet(context, ref),
            child: Container(
      ...
      body: isLoading
          ...
          : error != null
              ? Center(child: Text('Error: $error', style: const TextStyle(color: AppColors.r5)))
              : ListView(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(_fmt(net), style: const TextStyle(fontSize: 34, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: -1.5)),
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(_fmt(activos), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: Color(0xFF6EE7B7))),
                                ],
                              ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 2),
                                  Text(_fmt(deudas.abs()), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: Color(0xFFFCA5A5))),
                                ],
                              ),
                            ],
                          )
                    ...
                    if (wallets.isEmpty)
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                alignment: Alignment.center,
                                child: const Icon(LucideIcons.wallet, size: 30, color: AppColors.g3),
                              ),
                              const SizedBox(height: 12),
                              const Text("Sin cuentas", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.e8)),
                              const SizedBox(height: 4),
                              const Text("Agrega tu primera cuenta con el botón +", style: TextStyle(fontSize: 13, color: AppColors.g4)),
                            ],
                          ),
                      ...
                      ...groups.entries.toList().asMap().entries.map((groupEntry) {
                        ...
                        final items = wallets.where((w) => w.tipo == tipo).toList();
                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                const SizedBox(width: 8),
                                                Text(_fmt(w.saldo), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: w.saldo < 0 ? AppColors.r5 : AppColors.e8)),
                                              ],
                                            ),
                                          ),
                                        )
