                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(
                        widget.isGastos ? LucideIcons.trendingDown : LucideIcons.trendingUp,
                        size: 24,
                        color: widget.isGastos ? const Color(0xFFFCA5A5) : const Color(0xFF6EE7B7),
                      ),
                    ),
                  ],
                ),
                ...
                if (sortedKeys.isNotEmpty) ...[
                    ...
                    child: SizedBox(
                      ...
                      child: Row(
                        children: sortedKeys.map((key) {
                          final keyTotal = groups[key]!.fold(0.0, (s, t) => s + t.monto.abs());
                          final cat = _findCategory(key);
                          final color = cat?.color ?? AppColors.g4;
                          final flex = max(1, (keyTotal / (total > 0 ? total : 1) * 100).round());
                          return Expanded(
                            flex: flex,
                            child: Container(
                  ...
                  Wrap(
                    ...
                    children: sortedKeys.take(4).map((key) {
                      final cat = _findCategory(key);
                      final color = cat?.color ?? AppColors.g4;
                      final label = cat?.nombre ?? (key[0].toUpperCase() + key.substring(1));
                      final keyTotal = groups[key]!.fold(0.0, (s, t) => s + t.monto.abs());
                      final pct = total > 0 ? (keyTotal / total * 100).round() : 0;
                      return Row(
            ...
            child: filtered.isEmpty
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Container(
                          width: 56, height: 56,
                          decoration: BoxDecoration(color: accentLight, borderRadius: BorderRadius.circular(18)),
                          alignment: Alignment.center,
                          child: Icon(widget.isGastos ? LucideIcons.trendingDown : LucideIcons.trendingUp, size: 26, color: accentColor),
                        ),
                        const SizedBox(height: 12),
                        Text(
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final keyTotal = keyTxns.fold(0.0, (s, t) => s + t.monto.abs());
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isExpanded ? color.withValues(alpha: 0.35) : const Color(0xFFF3F4F6),
                              width: 1.5,
                            ),
                          ),
                          child: Column(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(label, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: AppColors.e8)),
                                              Text(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.w800,
                                                color: widget.isGastos ? AppColors.r5 : AppColors.e6,
                                              ),
                                            ),
                                            Text(
                                              "${(pct * 100).round()}%",
                                              style: const TextStyle(fontSize: 12, color: AppColors.g4, fontWeight: FontWeight.w600),
                                            ),
                                          ],
                                        ),
                                        ...
                                        AnimatedRotation(
                                          ...
                                          child: Icon(LucideIcons.chevronDown, size: 16, color: isExpanded ? color : AppColors.g3),
                                        ),
                                      ],
                                    ),
                                    const SizedBox(height: 12),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(t.desc, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.e8)),
                                              Text(_fmtDate(t.dateString), style: const TextStyle(fontSize: 11, color: AppColors.g4)),
                                            ],
                                          ),
                                        ),
                                        Text(
                      ...
                      ).animate().fadeIn(duration: 280.ms, delay: (i * 45).ms).slideY(begin: 0.05, end: 0, duration: 280.ms, delay: (i * 45).ms);
                    },
                  ),
          ),
        ],
